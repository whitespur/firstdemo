...
public class OrderCoach extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mLocationClient.setAK("DA39ebf529ed0e2333f252d69173ea17");//for FirstDemo
	...
	protected Dialog onCreateDialog(int id) {
		switch (id) {
		case DATE_DIALOG_ID:
			return new DatePickerDialog(this, mDateSetListener, mTime.year, mTime.month,
					mTime.monthDay);
		case TIME_DIALOG_ID:
			return new TimePickerDialog(this, mTimeSetListener, mTime.hour, mTime.minute,
					true);
		default:
	...
	private DatePickerDialog.OnDateSetListener mDateSetListener = new DatePickerDialog.OnDateSetListener() {
		...
		public void onDateSet(DatePicker view, int year, int monthOfYear,
			...
			Toast.makeText(OrderCoach.this, "year is " + mTime.year,
	...
	private TimePickerDialog.OnTimeSetListener mTimeSetListener = new TimePickerDialog.OnTimeSetListener() {
		...
		public void onTimeSet(TimePicker view, int hourOfDay, int minute) {
			...
			mTime.minute = minute;
			Toast.makeText(OrderCoach.this, "hour is " + mTime.hour,
					Toast.LENGTH_SHORT).show();
			setTime(mTimeButton, mTime.toMillis(true));
		}
	};
